# Generated by Django 4.0.3 on 2022-03-27 20:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[('Business', 'Business'), ('IT', 'It'), ('Banking', 'Banking'), ('Education', 'Education'), ('Telecomm', 'Telecomm'), ('Other', 'Other')], default='Business', max_length=30)),
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('1 Year', 'One Year'), ('2 Years', 'Two Year'), ('3 Years+', 'Three Year Plus')], default='No Experience', max_length=20)),
