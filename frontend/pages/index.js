...
export async function getServerSideProps({ query }) {
  ...
  const queryStr = `keyword=${keyword}&location=${location}&page=${page}&jobType=${jobType}&education=${education}&min_salary=${min_salary}&max_salary=${max_salary}&experience=${experience}`;
